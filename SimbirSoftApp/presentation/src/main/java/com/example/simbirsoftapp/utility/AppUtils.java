...
public class AppUtils {
    ...
    public void setActionBar(AppCompatActivity activity, View view, int titleRes, boolean setUpButton) {
    ...
    public String[] getRandomStringArray(Context context, int size, int arrRes) {
    ...
    public String[] findInArray(Context context, String query, int position) {
    ...
    public Drawable getDrawableByStringRes(Context context, String res) {
        Log.d("tag","res " + res);
        return context.getResources().getDrawable(context.getResources().getIdentifier(res,
                "drawable", context.getPackageName()));
    }

    public Spannable getUnderlineGreenSpan(Context context, int textRes) {
